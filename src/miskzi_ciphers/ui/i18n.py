...
CIPHER_LABELS: Final[dict[str, dict[str, str]]] = {
    "ru": {
        ...
        "feistel_network": "Учебная сеть Фейстеля",
        "gronsfeld": "Шифр Гронсфельда",
        "hill": "Шифр Хилла",
        "kuznechik": "Учебный Кузнечик",
        "litorea": "Русская литорея",
        "magma": "Блочный шифр Магма",
...
PARAM_LABELS: Final[dict[str, dict[str, str]]] = {
    "ru": {
        ...
        "feistel_network.keyword": "Ключевое слово",
        "gronsfeld.digits": "Цифровой ключ",
        "hill.matrix": "Матрица ключа",
        "hill.pad_char": "Символ дополнения",
        "kuznechik.key_hex": "Ключ (hex)",
        "magma.key_hex": "Ключ (hex)",
        ...
        "rc5.keyword": "Ключевое слово",
        "rc6.keyword": "Ключевое слово",
        "rc6.shift": "Циклический сдвиг",
...
PARAM_HELPS: Final[dict[str, dict[str, str]]] = {
    "ru": {
        ...
        "feistel_network.keyword": "Ключ из 4 русских букв без 'Ё'; по одной букве на раунд.",
        ...
        "kuznechik.key_hex": "Project-control ключ: 256-битный hex, потому что доступная ПЗ-7 даёт только теоретическое упоминание темы.",
        "magma.key_hex": "256-битный ключ в hex: ровно 64 шестнадцатеричных символа.",
        ...
        "rc5.keyword": "Ключ из 5 русских букв; страница 92 ПЗ-07 содержит методическую аномалию для кода буквы 'Л'.",
        "rc6.keyword": "Ключ из 5 русских букв из таблицы ПЗ-07.",
        "rc6.shift": "Учебный циклический сдвиг из варианта ПЗ-07.",
        ...
        "toy_aes.key_hex": "4-байтовый ключ в hex для внешнего учебного AES-подобного примера; шифр не относится к основной линии `docs/pdf/`.",
