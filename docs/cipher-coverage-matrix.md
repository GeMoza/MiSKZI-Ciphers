...
| `feistel_network` | no | no | no | no | yes | Есть в ПЗ-7 как учебная тема/алгоритмический блок; отдельного `cipher_id` в проекте пока нет. |
...
| `magma` | no | no | no | no | yes | Есть в ПЗ-7, но реализации, данных, UI-меток и тестов пока нет. |
...
| `rc5` | no | no | no | no | yes | Есть в ПЗ-7, но реализации, данных, UI-меток и тестов пока нет. |
| `rc6` | no | no | no | no | yes | Есть в ПЗ-7, но реализации, данных, UI-меток и тестов пока нет. |
